 ...
 * Date: [07/13/2026]
 *
 * Description: The purpose of this program is to calculate BMI using Feet & Inches for height and Lbs for weight.
 *
 * ***********************************************************************************************/
// Attributes: Name, heightft, height inches, cur(Weight), low, high
...
//Final Attributes:
// String name, status
// int heightF,heightI,height
// double cur, low, high, BMI
// Other Scanner, BGYellow, RESET
//Final Methods: dash, welcome, inputs1,totalHeight (noneed), bmi, status, report1,*Print(toString)*, index, goodbye, driver, main


import java.util.Date;
import java.util.Scanner;

public class BMI_CSC215_English_AhmadMustafa {
    ...
    public static void report1() {
        ...
        System.out.printf("-- BMI:                %.5f (or %.2f if rounded)", bmi(height, cur),BMI); //1.
